...
- (void)setDataArray:(NSArray *)dataArray {
    if (!_dataArray) {
        ...
        _scrollView.contentSize = CGSizeMake(_dataArray.count * WIDTH, HEIGHT - 40);
...
//        NSLog(@"current_contentOffset = %d",current_contentOffset);
        ...
        switch (_changeStyle) {
            ...
            case UICollectionViewCellChangeStyleIndentationStyle:
                ...
                break;
            case UICollectionViewCellChangeStyleCrawlStyle:
                [self crawlStyle:scrollView contentOffsetBefor:befor_contentOffset contentOffsetCurrent:current_contentOffset currentCollectionCell:cell leftSlide:rightCell rightSlide:leftCell];
            default:
                break;
        }
    } else {
